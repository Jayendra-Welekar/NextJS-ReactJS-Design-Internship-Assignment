    ...
    return (
        <div className='footer'>
            ...
            <div className='categories'>
                <p className='catg-h'>CATEGORIES</p>
                <p>Web Builder</p>
                <p>Hosting</p>
                <p>Data Center</p>
            ...
            <div className='selector'>
                <p>United States <svg width="15" height="9" viewBox="0 0 15 9" fill="none" xmlns="http://www.w3.org/2000/svg">
